...
export function AppMockup() {
  return (
    <div className="relative mx-auto w-full max-w-[23.5rem]" aria-label="Piatto App Vorschau mit Schnitzel Feed">
      ...
      <div className="relative rounded-[3.15rem] border border-[#25251d] bg-[#151611] p-[0.55rem] shadow-[0_34px_90px_rgba(52,38,24,0.34),inset_0_0_0_1px_rgba(255,255,255,0.09)]">
        ...
        <div className="overflow-hidden rounded-[2.55rem] bg-[#fffaf3]">
          <div className="relative border-b border-piatto-line/70 bg-[#fffaf3] px-4 pb-4 pt-14">
            ...
            <div className="relative mt-4 flex items-center gap-2 rounded-full border border-piatto-line bg-white/88 px-3 py-2.5 text-sm font-medium text-piatto-muted shadow-sm">
          ...
          <div className="px-4 pb-4 pt-4">
            <article className="overflow-hidden rounded-[1.55rem] border border-piatto-line bg-white shadow-[0_18px_36px_rgba(65,51,35,0.11)]">
              <div className="relative h-40 overflow-hidden bg-piatto-cream">
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between gap-3">
                  <div>
                    ...
                    <h2 className="mt-1 text-lg font-semibold leading-tight text-white">{featuredDish.name}</h2>
                  </div>
              ...
              <div className="flex items-center justify-between gap-3 px-3.5 py-3 text-xs font-semibold">
            ...
            <div className="mt-3 space-y-2.5">
              {feedDishes.map((dish) => (
                <article key={dish.name} className="rounded-[1.2rem] border border-piatto-line bg-white/92 p-2.5 shadow-[0_10px_24px_rgba(65,51,35,0.07)]">
                  <div className="flex gap-3">
                    <div className="relative size-[4.25rem] shrink-0 overflow-hidden rounded-[0.95rem] bg-piatto-cream">
                    ...
                    <div className="min-w-0 flex-1 py-0.5">
                      ...
                      <div className="mt-3 flex items-center justify-between text-[0.74rem] font-semibold">
...
function PiattoTabBar() {
  return (
    <div className="mt-3 grid grid-cols-5 items-end gap-1 rounded-[1.6rem] border border-piatto-line bg-[#fffaf3]/96 px-2 py-2 text-center text-[0.6rem] font-semibold text-piatto-muted shadow-[0_14px_30px_rgba(65,51,35,0.1)]">
      <span className="flex min-w-0 flex-col items-center gap-1 rounded-2xl px-1 py-1.5">
        <Home className="size-4 text-piatto-muted" aria-hidden="true" />
        Home
      </span>
      <span className="flex min-w-0 flex-col items-center gap-1 rounded-2xl px-1 py-1.5">
        <Search className="size-4 text-piatto-muted" aria-hidden="true" />
        Suche
      </span>
      <span className="flex min-w-0 -translate-y-2 flex-col items-center gap-1 rounded-[1.15rem] bg-piatto-terracotta px-1.5 py-2 text-white shadow-[0_14px_26px_rgba(217,108,59,0.26)] ring-4 ring-[#fffaf3]">
        <PiattoPlateMark className="size-8" />
      ...
      <span className="flex min-w-0 flex-col items-center gap-1 rounded-2xl px-1 py-1.5">
        <Heart className="size-4 text-piatto-muted" aria-hidden="true" />
        Favoriten
      </span>
      <span className="flex min-w-0 flex-col items-center gap-1 rounded-2xl px-1 py-1.5">
        <UserRound className="size-4 text-piatto-muted" aria-hidden="true" />
        Profil
      </span>
    </div>
  );
